  ...
  return (
    <div className="contact-us">
        ...
        <h2>Contact Us</h2>
            ...
            <div>
                <label htmlFor="subject">Why should we hire you as a:</label>
            ...
            <div>
                ...
                <textarea id="message" value={form.message} name="message" onChange={handleChange} placeholder="Write something..." />
            </div>
